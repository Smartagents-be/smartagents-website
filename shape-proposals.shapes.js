...
export const SHAPES = [
  ...
  /* -------------------------------------------------------------- 03 */
  {
    ...
    note: `Twee lassen: de hele rechterrand en het laatste stuk van de onderrand.
      ...
      golfrand. Ongelijke lobben verzachten dat, ze heffen het niet op. Dit is de
      vorm in de reeks waar het meest op af te dingen valt.`
  },
  /* -------------------------------------------------------------- 04 */
  {
    id: 'drapeCove',
  ...
  /* -------------------------------------------------------------- 13 */
  {
    ...
    note: `Gelast aan de onderlijn van het paneel, hangt naar links weg en loopt
      uit in een lange punt. De lange linkerflank, van de las tot vlak boven de
      punt, wijkt minder dan 3% van zijn eigen koorde af; de rechterflank zwaait
      er 10. Dat is wat hem onderscheidt van de vlam, die dezelfde plaats in de
      tekeningen inneemt maar dan omgekeerd en met twee ronde flanken. De eerste
      versie beweerde datzelfde en had het niet: beide flanken bogen ongeveer
      even veel, en het enige rechte stuk in de hele ring was een korte schouder
      naast de las. Bedoeld als tegengewicht — één vorm in de goot links van een
  ...
  /* -------------------------------------------------------------- 14 */
  {
    ...
    note: `De enige in de reeks die tekst zou kunnen dragen, en daarmee de
      ...
      dit ergens terugkomt, is het als het laatste woord van een lange pagina —
      één keer, en niets van dezelfde soort in de buurt.`
  },
  /* -------------------------------------------------------------- 15 */
  {
    id: 'seedFree',
  ...
  /* -------------------------------------------------------------- 19 */
  {
    ...
    context: 'prose',
    aspect: 1.15,
    slot: 'inset: 11% auto auto 48%; width: 170px; aspect-ratio: 1.15;',
    mockStyle: 'padding-right: 56%;',
    intent: 'Vrij zwevend, met één lichting aan de onderkant.',
    note: `Eén lange rug, en aan de onderkant één ondiepe lichting, zodat het
      lichaam op twee punten rust die noch even diep zijn noch even ver van de
      lichting liggen. De reliëfregel van de
      koepel op de trainingspagina staat hier op zijn kop, en dat is precies waar
      hij vandaan komt: die notitie zegt dat een tweede verlichting naast de
      eerste van de onderkant een rij schulpen maakt. Eén verlichting is er geen
      rij. Twee versies gingen hier al aan onderuit. De eerste had drie lobben
      aan de <i>boven</i>kant en las als een kroon. De tweede had er twee, met het
      zadel per ongeluk precies in het midden en beide voeten even diep —
      symmetrie die niemand bedoeld had en die de tekening tot een wolk maakte.
      Dat de holte hier aan de onderkant zit, bij de boon in een flank en bij de
      bolster in de kruin, is een verschil in bewerking en niet in stand; maar
      het is het krapste verschil in de reeks, en die drie horen niet samen op
      één pagina.`
  },
  /* -------------------------------------------------------------- 20 */
  {
...
const RINGS = {
  ...
  baySpine: [
    ...
    { p: [0.19, 0.36], t: [0, 1], full: 0.95 },
    { p: [0.64, 0.60], t: [0, 1], full: 0.75 },
    { p: [0.40, 0.84], t: [0.5, 1] },
  ...
  // flame.
  panelKeel: [
    { p: [0.46, 0], tin: [-1, 0], tout: [-0.13, 1] },
    { p: [0.38, 0.52], t: [-0.12, 1] },
    { p: [0.34, 0.96], t: [1, 0], full: 0.4 },
    { p: [0.86, 0.42], t: [0.4, -1] },
  ...
  // 19 — one long back, and one shallow lift under the body, off centre, so it
  // rests on two unequal points. The relief is on the underside because the two
  // free shapes beside it already carry one on top.
  stoneFree: [
    { p: [0.04, 0.44], t: [0.3, -1] },
    { p: [0.46, 0.04], t: [1, 0] },
    { p: [0.96, 0.44], t: [0.05, 1] },
    { p: [0.76, 0.93], t: [-1, 0], full: 0.9 },
    { p: [0.34, 0.80], t: [-1, 0], full: 0.9 },
    { p: [0.18, 0.97], t: [-1, 0], full: 0.9 }
  ],
