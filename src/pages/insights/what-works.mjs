...
export const body = {
  nl: [
    p`Er is een patroon dat we keer op keer zien bij organisaties die met AI beginnen
      ...
      Mensen die het vroeger moeilijker hadden, krijgen met AI een hefboom om dat verschil te
      overbruggen, als ze het aangrijpen als leermoment.`,
    p`AI is geen grote gelijkmaker. Maar het is wel een kans voor iedereen die bereid
      is mee te evolueren.`,
    h2`De vakkennis blijft de basis`,
    p`Een goede medewerker die AI leert gebruiken, werkt niet alleen sneller. Wie een goed
      rapport kon schrijven, schrijft er nu vijf in dezelfde tijd, elk even strak. Iemand die
      slim structureert, doet dat nu ook in processen die vroeger te complex waren om aan te
      pakken.`,
    ...
    p`Neem de PowerPoint. We spenderen er uren aan, soms dagen. Het resultaat is een bestand dat
      je één keer gebruikt, moeilijk deelt, niet kunt doorzoeken en na de presentatie vrijwel
      nooit meer bekijkt.`,
    p`Met AI kan je vandaag in tien à twintig minuten een website bouwen die functioneert als
      een interactief slide deck. Rijker in content, makkelijker te delen, altijd bereikbaar,
      en bijwerkbaar zonder opnieuw van nul te beginnen.`,
    p`Dit is geen randfenomeen. Het is een illustratie van een bredere verschuiving: wat vroeger
      uren kostte door technische drempels, kost nu minuten. De waarde zit niet langer in de
      technische uitvoering. De waarde zit in het denken erachter, de structuur, de boodschap,
      de toepassing.`,
    quote`De PowerPoint was nooit het doel. De PowerPoint was de prijs die je betaalde om je
      boodschap over te brengen. Die prijs bestaat niet meer.`,
    ...
    p`Organisaties die vandaag investeren in AI-vaardigheden bouwen een voorsprong op
      ...
      telt.`,
    p`Wie de boot mist, mist meer dan efficiëntie. Die mist ook de omzet die vrijkomt wanneer
      mensen die vroeger vastliepen op de uitvoering, nu bezig zijn met wat écht waarde
      toevoegt.`,
    h2`Waar beginnen?`,
    ...
    list([
      ...
      `**Wat kan AI minder goed?** Oordelen met context, ethische afwegingen, relaties
       onderhouden, omgaan met onverwachte situaties.`,
  ...
  en: [
    ...
    p`AI is not a great equaliser. But it is a genuine chance for anyone willing to
      grow with it.`,
    h2`Expertise remains the foundation`,
    p`A strong employee who learns to use AI doesn't just work faster. Someone who could write a
      solid report now writes five of them in the same time, each just as tight. Someone with
      a sharp instinct for structure now applies it to processes that were previously too
      complex to tackle.`,
    ...
    p`Take the PowerPoint. We spend hours on them, sometimes days. The result is a file used
      once, hard to share, unsearchable, and rarely looked at again after the meeting ends.`,
    p`With AI, you can build a website in ten to twenty minutes that functions as an
      interactive slide deck. Richer in content, easier to share, always accessible, and
      updatable without starting from scratch.`,
    p`This is not a fringe example. It illustrates a broader shift: what used to take hours
      because of technical barriers now takes minutes. The value is no longer in the technical
      execution. The value sits in the thinking behind it: the structure, the message, the
      application.`,
    quote`The PowerPoint was never the goal. It was the price you paid to get your message
      across. That price no longer exists.`,
    ...
    p`Those who miss the boat lose more than efficiency. They lose the revenue that opens up
      when people who were previously stuck on execution are now focused on what actually
      creates value.`,
    h2`Where to start`,
  ...
  fr: [
    ...
    h2`L'expertise reste la base`,
    p`Un bon collaborateur qui apprend à utiliser l'IA ne travaille pas seulement plus vite.
      Quelqu'un qui savait rédiger un bon rapport en écrit aujourd'hui cinq dans le même temps,
      tous aussi soignés. Quelqu'un qui a le sens de la structure l'applique désormais à des
      processus autrefois trop complexes pour être abordés.`,
    ...
    p`Prenez le PowerPoint. Nous y passons des heures, parfois des jours. Le résultat est un
      fichier utilisé une seule fois, difficile à partager, impossible à parcourir et presque
      jamais consulté une fois la présentation terminée.`,
    p`Avec l'IA, vous pouvez aujourd'hui construire en dix à vingt minutes un site web qui
      fonctionne comme un diaporama interactif. Plus riche en contenu, plus facile à partager,
      toujours accessible et modifiable sans devoir tout recommencer de zéro.`,
    p`Ce n'est pas un phénomène marginal. C'est l'illustration d'une évolution plus large : ce
      qui prenait des heures à cause de barrières techniques prend désormais quelques minutes.
      La valeur ne réside plus dans l'exécution technique. La valeur réside dans la réflexion
      qui la sous-tend : la structure, le message, l'application.`,
    quote`Le PowerPoint n'a jamais été le but. Le PowerPoint était le prix à payer pour faire
      passer votre message. Ce prix n'existe plus.`,
    ...
    p`Ceux qui ratent le coche perdent plus que de l'efficacité. Ils perdent le chiffre
      d'affaires qui se libère lorsque les personnes qui butaient autrefois sur l'exécution se
      consacrent désormais à ce qui crée réellement de la valeur.`,
    h2`Par où commencer ?`,
