// "Ontbijtsessie met Aviso+" — 12 June 2026. Ported from the Eleventy blog on
...
export const body = {
  nl: [
    ...
    p`Elk voorbeeld vertrok vanuit een herkenbare taak: een offerte opstellen, een
      mailbox ordenen, een dossier samenvatten. Niet de technologie stond centraal,
      wel het **werk dat er lichter van wordt**.`,
    h2`De échte impact zit in het gesprek`,
    p`Dank aan **Aviso+** voor het mooie partnership en de gastvrijheid. En dank aan
  ...
  en: [
    p`This morning the coffee was ready for a room full of business owners. Together
      with **Aviso+** we welcomed their clients for a breakfast session around one
      question that lives in a lot of SMEs: how do you actually put AI to work in
      your business?`,
    p`It is a question we hear often. AI sounds big, abstract, and a little far away.
    ...
    p`Every example started from a recognisable task: drafting a quote, sorting a
      mailbox, summarising a file. The technology was never the point. The **work that
      gets lighter** was.`,
    h2`The real impact is in the conversation`,
    p`Thanks to **Aviso+** for the partnership and the hospitality. And thanks to
      everyone who joined, for the engaging conversations and the sharp questions.
      That is exactly where the real impact begins: not with the tool, but with the
      question of what it means for your business.`,
    p`Curious how AI can make the difference in your SME? [Let's talk](#contact).`
  ],

  fr: [
    p`Ce matin, le café était prêt pour une salle remplie de dirigeants. Avec
      **Aviso+**, nous avons accueilli leurs clients pour un petit-déjeuner autour
      d'une question qui occupe beaucoup de PME: comment intégrer concrètement l'IA
      dans votre entreprise?`,
    p`C'est une question que nous entendons souvent. L'IA paraît vaste, abstraite et
    ...
    p`Chaque exemple partait d'une tâche reconnaissable: rédiger une offre, organiser
      une boîte mail, résumer un dossier. La technologie n'était jamais au centre,
      mais bien le **travail qui en devient plus léger**.`,
    h2`Le véritable impact se trouve dans la conversation`,
    p`Merci à **Aviso+** pour ce beau partenariat et pour l'accueil. Et merci à toutes
      les personnes présentes, pour les échanges enrichissants et les questions
      critiques. C'est précisément là que commence le véritable impact: pas avec
      l'outil, mais avec la question de ce qu'il représente pour votre entreprise.`,
    p`Curieux de savoir comment l'IA peut faire la différence dans votre PME?
