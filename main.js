...
const translations = {
    en: {
        ...
        'testimonials.1.name': 'Jan De Smet',
        'testimonials.1.role': 'CTO, TechFlow Belgium',
        ...
        'testimonials.2.name': 'Marie Vermeersch',
        'testimonials.2.role': 'Operations Director, LogiPrime',
        ...
        'testimonials.3.name': 'Peter Lenaerts',
        'testimonials.3.role': 'CEO, DataDriven NV',
    ...
    nl: {
        ...
        'contact.subtitle': 'Klaar om kosten te besparen en de groei van je bedrijf te versnellen?',
