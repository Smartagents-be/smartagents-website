...
const translations = {
    ...
    nl: {
        ...
        'hero.subtitle': 'Wij leveren geavanceerde AI-oplossingen, agentische systemen en procesoptimalisatie om uw digitale transformatie te versnellen.',
        'hero.cta.primary': 'Aan de Slag',
        'hero.cta.secondary': 'Meer Info',
        'services.title': 'Onze Diensten',
        'services.subtitle': 'Uitgebreide oplossingen om uw operaties te optimaliseren en innovatie te stimuleren',
        ...
        'services.agentic.title': 'Agentische AI',
        'services.agentic.desc': 'Autonome AI-agenten die kunnen redeneren, plannen en complexe taken uitvoeren. Bouw intelligente systemen die samenwerken met uw team.',
        ...
        'services.training.title': 'Training',
        'services.training.desc': 'Uitgebreide trainingsprogramma\'s om uw team bij te scholen in AI, automatisering en opkomende technologieën. Praktische workshops en certificeringscursussen.',
        'services.secure.title': 'Beveiliging',
        'services.secure.desc': 'Enterprise-grade beveiligingsoplossingen voor uw AI-systemen. Gegevensbescherming, compliance frameworks en veilige implementatie van automatiseringsworkflows.',
        ...
        'team.axel.bio': 'Ondernemer met 20+ jaar ervaring in digitale transformatie. Gepassioneerd over het helpen van bedrijven met intelligente automatisering.',
        'team.tomv.role': 'Oprichter',
        'team.tomv.bio': 'Technisch architect gespecialiseerd in agentische AI-systemen en enterprise automatisering. Bouwt schaalbare oplossingen die echte resultaten opleveren.',
        'team.agents.name': 'Onze Agents',
        'team.agents.role': 'Mens + AI Samenwerking',
        'team.agents.bio': 'Onze slimme menselijke en AI-agents die waardevolle resultaten creëren.',
        'contact.title': 'Laten We Praten',
        'contact.subtitle': 'Klaar om uw bedrijf te optimaliseren? Neem contact op met ons team.',
