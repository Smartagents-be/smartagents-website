...
const translations = {
    en: {
        ...
        'values.title': 'Values',
        'values.headline': 'Transparency, trust, and real impact',
        'values.text': 'We believe in honest communication, measurable results, and long-term partnerships. Every solution we build is rooted in integrity \u2014 no hidden complexity, no empty promises. Just technology that genuinely makes a difference.',
        ...
        'aanpak.step1.title': '<a href="services/smart-scan.html" style="color:inherit;text-decoration:none;">Smart Scan</a>',
        'aanpak.step1.desc': 'We map your processes and bottlenecks. Where can AI make the difference?',
        'aanpak.step1.btn': 'Learn more',
        ...
        'team.agents.name': 'People with a mission, agents with a vision',
        'team.agents.role': 'The best of both worlds',
        ...
        'services.ai.page.features.title': 'Our solutions',
        ...
        'services.agentic.page.features.title': 'Our services',
        ...
        'services.process.page.features.title': 'Our services',
        ...
        'services.automation.page.features.title': 'Our services',
        ...
        'services.training.page.features.title': 'Our training offer',
        ...
        'services.secure.page.features.title': 'Our services',
    ...
    nl: {
        ...
        'values.title': 'Waarden',
        'values.headline': 'Transparantie, vertrouwen en echte impact',
        'values.text': 'Wij geloven in eerlijke communicatie, meetbare resultaten en langdurige partnerschappen. Elke oplossing die wij bouwen is geworteld in integriteit \u2014 geen verborgen complexiteit, geen loze beloften. Gewoon technologie die echt het verschil maakt.',
        ...
        'team.agents.name': 'Mensen met een missie, agents met een visie',
        'team.agents.role': 'Het beste van twee werelden',
        ...
        'services.ai.page.features.title': 'Onze oplossingen',
        ...
        'services.agentic.page.features.title': 'Onze diensten',
        ...
        'services.process.page.features.title': 'Onze diensten',
        ...
        'services.automation.page.features.title': 'Onze diensten',
        ...
        'services.training.page.features.title': 'Ons trainingsaanbod',
        ...
        'services.secure.page.features.title': 'Onze diensten',
